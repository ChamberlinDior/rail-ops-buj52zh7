...
(async()=>{
 ...
 await page.evaluate(async()=>{
   ...
   document.querySelector('[data-doc-open="ticket"]')?.click();
   await new Promise(r=>setTimeout(r,700));
   document.querySelector('[data-doc="receipt"]')?.click();
   await new Promise(r=>setTimeout(r,900));
 });
 await page.waitForTimeout(2500);
 await page.screenshot({path:path.resolve(__dirname,'verify-receipt.png'),fullPage:false});
 await browser.close();

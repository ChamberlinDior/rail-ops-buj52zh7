...
<div class="bp-present"><button data-bp-exit>${I('x')} Quitter</button><span><b data-bp-num>1</b> / <b data-bp-total>6</b></span><button data-bp-prev>${I('arrow-left')}</button><button data-bp-next>${I('arrow-right')}</button></div>
</div>`;
